...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `OffscreenCanvasRenderingContext2D`, `HtmlCanvasElement`*"]
    pub fn canvas(this: &OffscreenCanvasRenderingContext2D) -> Option<HtmlCanvasElement>;
    ...
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/OffscreenCanvasRenderingContext2D/createPattern)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `CanvasPattern`, `OffscreenCanvasRenderingContext2D`, `HtmlCanvasElement`*"]
